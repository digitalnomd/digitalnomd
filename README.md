...
- [Project Name](https://github.com/digitalnomd/project) - one-line outcome, not just a description.

## Current Projects

### Coding Agents

- [Project Name](https://github.com/digitalnomd/project) - agent capability, eval, or infrastructure result.

### Infrastructure

- [Project Name](https://github.com/digitalnomd/project) - distributed systems, PostgreSQL, orchestration, or reliability result.

### Developer Tools

- [Project Name](https://github.com/digitalnomd/project) - CLI, workflow, automation, or debugging result.

## Writing

- [Post Title](https://example.com) - short subject.

## Connect

- [LinkedIn](https://www.linkedin.com/in/rob-grossman-42837414a/)
-->
